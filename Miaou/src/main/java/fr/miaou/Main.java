        ...
        if (con.agTypeAgent(id) == 1){
            while(true){
                ...
                if (choice == 1){
                    ...
                    int mois = sc.nextInt();
                    System.out.println("Choisissez le type de frais : ");
                    ...
                    if (choice == 1){
                        ...
                        con.createFraisForfaitaire(frais, id, mfrId, quantite, mois);
                    } else if (choice == 2){
                        System.out.println("Quantité : ");
                        quantite = sc.nextInt();
                        mfrId = 0;
                        ...
                        quantite = sc.nextInt();
                        con.createFraisKm(frais, id, quantite, mois);
                    } else if (choice == 4){
